...
class TextBox_Placeholder(ctk.CTkTextbox):
    def __init__(self, master: any, width: int = 200, height: int = 200,
                 ...
                 border_spacing: int = 3, bg_color: str | Tuple[str, str] = "transparent",
                 fg_color: str | Tuple[str, str] | None = None,
                 border_color: str | Tuple[str, str] | None = None,
                 text_color: str | None = None, scrollbar_button_color: str | Tuple[str, str] | None = None,
                 scrollbar_button_hover_color: str | Tuple[str, str] | None = None,
                 font: tuple | CTkFont | None = None, activate_scrollbars: bool = True,
                 placeholder: str = 'Default Placeholder', # why has no one THINK OF THIS?
        ...
        if self.placeholder_clr == self.default_clr:
            raise ValueError("Placeholder color is the same as Default Input color!")
...
if __name__ == "__main__":
    ...
    nothing = ctk.CTkButton(a.main_frame, text='Out of focus', command=lambda : nothing.focus())
